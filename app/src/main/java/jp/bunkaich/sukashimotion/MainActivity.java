...
public final class MainActivity extends Activity {
    ...
    private void startMotion(){
        ...
        if(!DeviceModels.allowed(Build.MODEL)){Toast.makeText(this,getString(R.string.unsupported_device),Toast.LENGTH_LONG).show();return;}
    ...
    static String formatReport(Context c,Bundle b){
        StringBuilder text=new StringBuilder(Build.MODEL+" / Android "+Build.VERSION.RELEASE+" / "+Build.DISPLAY+"\n"+c.getString(R.string.probe_permissions,b.getInt("uid"),c.getString(b.getBoolean("samsungPermission")?R.string.yes:R.string.no)));
