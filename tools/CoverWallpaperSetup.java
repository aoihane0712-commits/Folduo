...
public final class CoverWallpaperSetup {
    ...
    private static void run(String[] args) throws Exception {
        ...
        if (android.os.Process.myUid() != 2000 || !jp.bunkaich.sukashimotion.DeviceModels.allowed(Build.MODEL))
            throw new IllegalStateException("This setup is limited to ADB shell on SM-F966Z or experimental SM-F966Q");
